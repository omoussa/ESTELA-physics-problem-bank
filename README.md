...
> **Extra exporters (enhanced build):** the **[Enhanced Exam Builder →](https://zhongzhou.github.io/ESTELA-physics-problem-bank/standalone-enhanced.html)** additionally exports LaTeX `.tex` (exam + answer key), an `Exams/`/`Keys/`/`Images/` bundle `.zip`, and a Word `.doc` (beta — math fidelity limited), and can pull banks straight from GitHub — all client-side. See [`docs/enhanced-web-builder.md`](./docs/enhanced-web-builder.md).
